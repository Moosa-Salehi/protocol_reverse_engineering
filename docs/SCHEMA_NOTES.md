...
python scripts/05_extract_features.py data/01_messages.jsonl data/03_features --assignments-json data/02_family_assignments.json
python scripts/06_infer_boundaries.py data/01_messages.jsonl data/04_families.json --assignments-json data/02_family_assignments.json
python scripts/07_pair_requests_responses.py data/01_messages.jsonl data/05_pairs.json --assignments-json data/02_family_assignments.json
python scripts/08_infer_keywords.py data/01_messages.jsonl data/06_keywords.json --assignments-json data/02_family_assignments.json
python scripts/09_compare_subcluster_hypotheses.py data/01_messages.jsonl data/07_subcluster_hypotheses.json --assignments-json data/02_family_assignments.json
python scripts/10_infer_relations.py data/01_messages.jsonl data/02_family_assignments.json data/05_pairs.json data/08_relations.json
python scripts/11_infer_semantics.py data/04_families.json data/08_relations.json data/09_semantics.json
python scripts/12_build_protocol_model.py data/04_families.json data/10_protocol_model.json --relations-json data/08_relations.json --semantics-json data/09_semantics.json
python scripts/13_export_markdown.py data/10_protocol_model.json data/protocol_spec.md
```
